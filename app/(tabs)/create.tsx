...
export default function CreateScreen() {
  ...
  //  we can create mutations and consume it in components
  ...
  const handleShare = async ( ) =>{
    ...
    // we have to check if thee is sa selected image 
    ...
    try {
      ...
      // once everything is doe successfully we route to the homepage
  ...
  //  check if it is not selected image
